...
export const translations = {
  ...
  'nav-game':         { zh: '守護小鳥大挑戰',    en: 'Little Bird Guardian Challenge' },
  ...
  'card-game-title':  { zh: '守護小鳥大挑戰',    en: 'Little Bird Guardian Challenge' },
  'card-game-desc':   { zh: '保護小鳥躲避危險，獲得高分！',  en: 'Protect the little bird from dangers and get high scores!' },
  ...
  // =================== Game Page ===================
  'nav-game':         { zh: '守護小鳥大挑戰',          en: 'Little Bird Guardian Challenge' },
  'game-start-title': { zh: 'LITTLE BIRD CHALLENGE',     en: 'LITTLE BIRD CHALLENGE' },
  'game-start-desc':  { zh: '保護可愛的小鳥！點擊屏幕讓牠向上飛，收集星星並躲開危險的烏鴉。', en: 'Protect the cute little bird! Click to fly up, collect stars and avoid dangerous crows.' },
  ...
  'game-ready':       { zh: '準備好了嗎？',          en: 'READY?' },
  'game-click-start': { zh: '點擊開始！',           en: 'CLICK TO START!' },

  // =================== Login ===================
  'login-welcome':    { zh: '華仁鳥屋監察及生態網站',    en: 'Wah Yan Bird House Monitoring and Ecosystem Website' },
  ...
  'login-name-short': { zh: '這個名字太短了喔！Gu Gu!', en: 'That name is too short! Gu Gu!' },
  'login-name-long':  { zh: '名字太長了，請保持在 15 個字以內！Gu Gu!', en: 'That name is too long! Keep it under 15 chars! Gu Gu!' },
  'login-name-forbidden': { zh: '停止！此名字已被禁止。請選擇一個得體的稱呼！Gu Gu!', en: 'STOP! This name is strictly forbidden. Choose a respectful identity! Gu Gu!' },
  'login-welcome-name': { zh: 'Gu Gu Gu! 歡迎你，{name}！', en: 'Gu Gu Gu! Welcome, {name}!' },
  'login-welcome-guest': { zh: '歡迎你，探險家！', en: 'Welcome, Explorer!' },
  'mascot-bye':       { zh: '期待你的下次探索！Gu Gu!', en: 'See you next time! Gu Gu!' },
  ...
  'badge-monitoring': { zh: '24/7 實時監測', en: '24/7 MONITORING' },
  'showoff-live-msg': { zh: '剛剛收到！{name} 剛剛投票給了 {bird}！Gu!', en: 'News! {name} voted for {bird}! Gu!' },
  'showoff-live-title': { zh: '專案宣傳影片 LIVE', en: 'Project Promo LIVE' },
  'showoff-rank-title': { zh: '即時人氣榜 (TOP 3)', en: 'Live Leaderboard (TOP 3)' },
  'showoff-scan-vote':  { zh: '掃碼投票 SCAN TO VOTE', en: 'SCAN TO VOTE' },
  'showoff-ticker-1':   { zh: '⚡ 本地生態監測中', en: '⚡ Local ecosystem monitoring' },
  'showoff-ticker-2':   { zh: '🌲 校園目前的鳥類活動頻率：高', en: '🌲 Campus bird activity: HIGH' },
  'showoff-ticker-3':   { zh: '🕊️ 感謝參與投票！', en: '🕊️ Thanks for voting!' },
  'showoff-ticker-4':   { zh: '⛅ 天氣：晴', en: '⛅ Weather: Sunny' },
  'showoff-exit':       { zh: '← 退出', en: '← Exit' },
  'showoff-mascot-1':   { zh: '歡迎來到 Gu Gu Gu 展位！✨', en: 'Welcome to Gu Gu Gu booth! ✨' },
  'showoff-mascot-2':   { zh: '快拿起手機，掃碼投下你神聖的一票！🕊️', en: 'Scan QR to cast your vote! 🕊️' },
  'showoff-mascot-3':   { zh: '你知道嗎？校園裡其實有很多隱藏的鳥類明星哦！', en: 'Did you know? There are many bird stars on campus!' },
  'showoff-mascot-4':   { zh: '我是展覽限定版的 Gu Gu，大家多多指教！🌿', en: 'I am the exhibition version Gu Gu! 🌿' },
  'showoff-mascot-5':   { zh: '看！影片裡正拍到精彩的畫面呢！🎬', en: 'Look! The video shows amazing moments! 🎬' },
  'showoff-mascot-6':   { zh: '目前第一名競爭非常激烈呀！Gu! 🔥', en: 'The top race is so intense! Gu! 🔥' },
  'vote-error-counts':  { zh: '連線錯誤，但你的投票已計算！', en: 'Connection Error, but your vote counts!' },
  'btn-continue-spark': { zh: '繼續 ✨', en: 'CONTINUE ✨' },
  'audio-coming-soon': { zh: '語音製作中，敬請期待！Gu!', en: 'Audio coming soon! Gu!' },
  'audio-missing':     { zh: '哎呀！這隻小鳥今天比較害羞 (音檔缺失)。', en: 'Oops! This bird is shy today (Audio missing).' },
  'mascot-hi':          { zh: 'Gu Gu Gu!', en: 'Gu Gu Gu!' },
  'ency-view-details': { zh: '查看詳情 View Details', en: 'View Details' },
  ...
  // =================== Daily Facts ===================
  'fact-1': { zh: '紅耳鵯最喜歡在校園的榕樹上聚集！', en: 'Red-whiskered Bulbuls love gathering on the banyan trees!' },
